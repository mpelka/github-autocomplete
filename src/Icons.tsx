...
export function IconSpin(): JSX.Element {
  return (
    <svg
      role="progressbar"
      className="makersden-autocomplete--icon-spinner"
...
export function IconCross(): JSX.Element {
  return (
    <svg className="makersden-autocomplete--icon-cross" viewBox="0 0 14 14">
      <path
...
export function IconSearch(): JSX.Element {
  return (
    <svg className="makersden-autocomplete--icon-search" viewBox="0 0 16 16" fill="currentColor">
...
export function IconRepo(): JSX.Element {
  return (
    <svg className="makersden-autocomplete--icon-repo" fill="currentColor" viewBox="0 0 16 16" version="1.1">
      <path
        fillRule="evenodd"
...
export function IconUser(): JSX.Element {
  return (
    <svg fill="currentColor" className="makersden-autocomplete--icon-user" viewBox="0 0 24 24">
